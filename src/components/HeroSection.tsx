        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="flex items-center justify-between space-x-6 py-6 lg:space-x-10">
            ...
            <Popover.Group as="nav" className="hidden space-x-4 md:flex lg:space-x-10">
              ...
              <a href="https://www.epa-bienestar.com/prevencion.html" className="text-base font-normal text-gray-500 hover:text-gray-900">
                Cómo funciona
              </a>
              <a href="https://pacientes.epa-bienestar.com" className="text-base font-normal text-gray-500 hover:text-gray-900">
                Profesionales
              </a>
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6">
	    ...
	    <div className="mt-8 sm:flex sm:justify-center md:mt-20 lg:justify-start">
              <div className="rounded-md shadow">
                ...
                >
                  Ingresar!
                </a>Enlance para usuarios registrados
              </div>
            </div>
            <div className="mt-8 sm:flex sm:justify-center md:mt-20 lg:justify-start">
              <div className="rounded-md shadow">
                ...
                >
                  Crear cuenta!
                </a>Enlance para alta de nuevo usuario
              </div>
            </div>
          </div>
          <img
